(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".coffee__slider")) {
                const swiper1 = new core(".coffee__slider", {
                    ...
                    on: {
                        init: function() {
                            ...
                            sliderSlides.forEach(((sliderSlide, index) => {
                                if (index >= countViewSlides) sliderSlide.classList.add("outside");
                            }));
                        }
                    }
                });
            ...
            if (document.querySelector(".combo__slider")) {
                const swiper1 = new core(".combo__slider", {
                    modules: [ Navigation, Grid ],
                    grabCursor: true,
                    observer: true,
                    observeParents: true,
        ...
        function OpacitySlide(e) {
            ...
            sliderSlides.forEach(((sliderSlide, index) => {
                if (index >= numberSlide * gridRows && index < numberSlide * gridRows + gridRows * e.params.slidesPerView) {
                    if (sliderSlide.classList.contains("outside")) sliderSlide.classList.remove("outside");
                } else if (!sliderSlide.classList.contains("outside")) sliderSlide.classList.add("outside");
            }));
        }
